...
class PlayingCardView: UIView {
    ...
    private func centeredAttributedString(_ string: String, fontSize: CGFloat) -> NSAttributedString {
        ...
        font = UIFontMetrics(forTextStyle: .body).scaledFont(for: font)     //Take advantage of Settings-->Accessibility-->larger fonts
    ...
    override func layoutSubviews() {
        ...
        lowerRightCornerLabel.frame.origin = CGPoint(x: bounds.maxX, y: bounds.maxY)
            .offsetBy(dx: -cornerOffset, dy:-cornerOffset)
            .offsetBy(diagonalOf: lowerRightCornerLabel.frame, positive: false)
    ...
    private func drawPips() {
        ...
        func createPipString(thatFits pipRect: CGRect) -> NSAttributedString {
            ...
            if probablyOkayPipString.size().width > pipRect.size.width / maxHorizontalPipCount {
                return centeredAttributedString(suit, fontSize: probablyOkayPipStringFontSize / (probablyOkayPipString.size().width /
    ...
    override func draw(_ rect: CGRect) {
        ...
        //        path.addArc(withCenter: CGPoint(x: bounds.midX, y: bounds.midY), radius: 150, startAngle: 0, endAngle: 2*CGFloat.pi, clockwise: false)
        //        path.lineWidth = 5.0
        //        UIColor.yellow.setFill()
        //        UIColor.red.setStroke()
        //        path.stroke()
...
extension CGPoint {
    ...
    func offsetBy(diagonalOf: CGRect, positive: Bool) -> CGPoint {
        let multiplier = CGFloat(positive ? 1 : -1)
        return CGPoint(x: x+diagonalOf.width*multiplier, y: y+diagonalOf.height*multiplier)
    }
}
